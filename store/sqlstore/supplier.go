...
func NewSqlSupplier(settings model.SqlSettings) *SqlSupplier {
	...
	supplier.oldStores.application.(*SqlApplicationStore).CreateIndexesIfNotExists()
...
func (ss *SqlSupplier) Section() store.SectionStore {
	return ss.oldStores.section
}
...
func (ss *SqlSupplier) Application() store.ApplicationStore {
	return ss.oldStores.application
}
