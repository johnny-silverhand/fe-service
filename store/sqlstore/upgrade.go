...
func UpgradeDatabase(sqlStore SqlStore) {
	...
	if sqlStore.GetCurrentSchemaVersion() != model.CurrentVersion {
		mlog.Critical(fmt.Sprintf("Database schema version %v is no longer supported. This server supports automatic upgrades from schema version %v through schema version %v. Downgrades are not supported. Please manually upgrade to at least version %v before continuing", sqlStore.GetCurrentSchemaVersion(), OLDEST_SUPPORTED_VERSION, model.CurrentVersion, OLDEST_SUPPORTED_VERSION))
		time.Sleep(time.Second)
...
func UpgradeDatabaseToVersion49(sqlStore SqlStore) {
	// This version of includes an App-Layer migration which migrates from hard-coded roles configured by
...
func UpgradeDatabaseToVersion50(sqlStore SqlStore) {
	// This version of includes an App-Layer migration which migrates from hard-coded emojis configured
	...
	// This version of also includes a online-migration which migrates some roles from the `Roles` columns of
	// TeamMember and ChannelMember rows to the new SchemeAdmin and SchemeUser columns. If you need to downgrade to a
	// version of prior to 5.0, you should take your server offline and run the following SQL statements
...
func UpgradeDatabaseToVersion513(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_12_0, VERSION_5_13_0) {
		...
		sqlStore.CreateColumnIfNotExists("Sessions", "OfficeId", "varchar(26)", "varchar(26)", "")
		sqlStore.CreateColumnIfNotExists("Applications", "PaymentDetails", "varchar(1000)", "varchar(1000)", "")
...
func UpgradeDatabaseToVersion515(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_14_0, VERSION_5_15_0) {
		sqlStore.CreateColumnIfNotExists("Applications", "MaxDiscount", "int", "int", "0")
		sqlStore.CreateColumnIfNotExists("Users", "InvitedBy", "varchar(255)", "varchar(255)", "")

		sqlStore.CreateColumnIfNotExists("Applications", "AqType", "varchar(1000)", "varchar(1000)", "")
		sqlStore.CreateColumnIfNotExists("Applications", "AqUsername", "varchar(1000)", "varchar(1000)", "")
		sqlStore.CreateColumnIfNotExists("Applications", "AqPassword", "varchar(1000)", "varchar(1000)", "")
...
func UpgradeDatabaseToVersion516(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_15_0, VERSION_5_16_0) {
		sqlStore.CreateColumnIfNotExists("Applications", "Cash", "tinyint(1)", "boolean", "0")
		sqlStore.CreateColumnIfNotExists("Promos", "BeginAt", "bigint(20)", "bigint(20)", "0")
		sqlStore.CreateColumnIfNotExists("Promos", "ExpireAt", "bigint(20)", "bigint(20)", "0")
		sqlStore.CreateColumnIfNotExists("Transactions", "Type", "varchar(255)", "varchar(255)", "")
...
func UpgradeDatabaseToVersion517(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_16_0, VERSION_5_17_0) {
		sqlStore.CreateColumnIfNotExists("Users", "BirthdayAt", "bigint(20)", "bigint(20)", "0")
...
func UpgradeDatabaseToVersion519(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_18_0, VERSION_5_19_0) {
		sqlStore.CreateColumnIfNotExists("Applications", "Cashback", "int", "int", "0")
...
func UpgradeDatabaseToVersion520(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_19_0, VERSION_5_20_0) {
		sqlStore.CreateColumnIfNotExists("Products", "Extra", "tinyint(1)", "boolean", "0")
...
func UpgradeDatabaseToVersion521(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_20_0, VERSION_5_21_0) {
		sqlStore.CreateColumnIfNotExists("Products", "PrivateRule", "tinyint(1)", "boolean", "0")
		sqlStore.CreateColumnIfNotExists("Baskets", "Cashback", "int", "int", "0")
...
func UpgradeDatabaseToVersion522(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_21_0, VERSION_5_22_0) {
		sqlStore.CreateColumnIfNotExists("Products", "Type", "varchar(255)", "varchar(255)", "")
		sqlStore.CreateColumnIfNotExists("Orders", "Processing", "tinyint(1)", "boolean", "0")
...
func UpgradeDatabaseToVersion524(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_23_0, VERSION_5_24_0) {
		sqlStore.CreateColumnIfNotExists("Applications", "BlockedAt", "bigint(20)", "bigint(20)", "0")
		sqlStore.CreateColumnIfNotExists("Users", "BlockedAt", "bigint(20)", "bigint(20)", "0")
...
func UpgradeDatabaseToVersion526(sqlStore SqlStore) {
	if shouldPerformUpgrade(sqlStore, VERSION_5_25_0, VERSION_5_26_0) {
		...
		sqlStore.CreateColumnIfNotExists("Transactions", "CreatedBy", "varchar(255)", "varchar(255)", "")
		sqlStore.CreateColumnIfNotExists("Applications", "RegBonus", "int", "int", "0")
		//sqlStore.CreateColumnIfNotExistsNoDefault("Applications", "ContactDetails", "text", "text")
