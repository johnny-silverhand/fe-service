...
type Post struct {
	...
	// by for presentation (e.g if an image proxy is being used). It should be used to
...
func (o *MessageArray) AddOrder(id string) {
...
func (o *MessageArray) AddMessage(post *Post) {

	if o.Messages == nil {
		o.Messages = make([]*Post, 0, 128)
	}
