...
// CreateOAuthApp will register a new OAuth 2.0 client application with acting as an OAuth 2.0 service provider.
...
// UpdateOAuthApp updates a page of registered OAuth 2.0 client applications with acting as an OAuth 2.0 service provider.
...
// GetOAuthApps gets a page of registered OAuth 2.0 client applications with acting as an OAuth 2.0 service provider.
...
// GetOAuthApp gets a registered OAuth 2.0 client application with acting as an OAuth 2.0 service provider.
...
// GetOAuthAppInfo gets a sanitized version of a registered OAuth 2.0 client application with acting as an OAuth 2.0 service provider.
