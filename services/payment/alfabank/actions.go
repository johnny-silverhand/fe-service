...
import (
	...
	"encoding/json"
	"fmt"
	"im/services/payment/alfabank/endpoints"
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:register
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:registerpreauth
...
// Deposit request
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:deposit
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:reverse
...
// RefundOrder request
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:refund
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:getorderstatusextended
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:verifyEnrollment
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:updateSSLCardList
...
// BindCard request
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:bindcard
...
// UnBindCard request
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:unbindcard
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:extendbinding
...
// GetBindings request
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:getbindings
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:getreceiptstatus
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:payment_applepay
...
// see https://securepayments.alfabank.ru/wiki/doku.php/integration:api:rest:requests:payment_googlepay
