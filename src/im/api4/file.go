...
func getFile(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if info.CreatorId != c.App.Session.UserId && !c.App.SessionHasPermissionToChannelByPost(c.App.Session, info.MetadataId, model.PERMISSION_READ_CHANNEL) {
