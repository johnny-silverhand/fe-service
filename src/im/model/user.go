...
const (
	...
	TEST_USER_NICKNAME = "TestAccount"
	TEST_USER_PHONE    = "71230000000"
	TEST_USER_PASSWD   = "1111"
)
...
func (u *User) SetDefaultNotifications() {
	...
	u.NotifyProps[PUSH_NOTIFY_PROP] = USER_NOTIFY_ALL
...
func (u *User) IsOAuthUser() bool {
	return false //u.AuthService == USER_AUTH_SERVICE_GITLAB
}
